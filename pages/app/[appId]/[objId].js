            ...
            <React.Fragment key={`layout-frag${Math.random()}`}>
              ...
              }
              {
                (
                  ...
                  <Grid item xs={12} md={4} key={index}>
                    <Typography variant="subtitle2">{fieldsToRender[index]['label']}:<Typography variant="body2">{object[fieldsToRender[index]['id']].fullName}</Typography></Typography>
                  </Grid>
            ...
            <Toolbar className={classes.toolbarStyle} variant="dense">
              <div>
                ...
                <Typography variant="caption">
                  Created on <Moment format={this.props.siteInfo.dateFormat}>{object.createdAt}</Moment> | Created By {object.fk_createdBy.fullName}
                </Typography>
              </div>
